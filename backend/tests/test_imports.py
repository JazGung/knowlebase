...
def test_imports():
    ...
    modules_to_test = [
        ...
        ("knowlebase.resource.document.service", "UploadService"),
        ("knowlebase.resource.document.service", "DocumentService"),
        ...
        ("knowlebase.schemas.model", "ParseRequest"),
        ("knowlebase.schemas.model", "EmbeddingRequest"),
        ("knowlebase.resource.document.api", "router"),
        ("knowlebase.build.processing.api", "router"),
        ("knowlebase.build.query.api", "router"),
        ("knowlebase.resource", "resource_router"),
        ("knowlebase.build", "build_router"),
        ("knowlebase.model", "model_router"),
        ("knowlebase.model.api", "router"),
        ("knowlebase.main", "app"),
        ...
        ("knowlebase.build.processing.service", "ProcessingService"),
        ("knowlebase.build.query.service", "ProcessingQueryService"),
