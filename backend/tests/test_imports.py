...
def test_imports():
    ...
    modules_to_test = [
        ...
        ("knowlebase.services.upload_service", "UploadService"),
        ("knowlebase.services.document_service", "DocumentService"),
        ...
        ("knowlebase.admin.api.v1.endpoints.documents", "router"),
        ("knowlebase.admin.api.v1.routers.build", "build_router"),
        ("knowlebase.main", "app"),
    ]
